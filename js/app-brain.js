...
var names = {2: ['Arousal', 'Manipulation'],
             ...
             9: ['Memory', 'Anticipation', 'Reward', 'Cognitive Process', 'Manipulation', 'Vision', 'Word', 'Perception', 'Language'],
             10: ['Memory', 'Reward', 'Arousal', 'Cognitive', 'Manipulation', 'Episodic Memory', 'Retrieval', 'Vision', 'Perception', 'Language'],
             11: ['Memory', 'Episodic Memory', 'Emotion', 'Cognitive', 'Reward', 'Arousal', 'Manipulation', 'Vision', 'Hearing', 'Language', 'Cognitive Process'],
             12: ['Memory', 'Retrieval', 'Episodic Memory', 'Reward', 'Anticipation', 'Emotion', 'Arousal', 'Cognition', 'Manipulation', 'Vision', 'Hearing', 'Language'],
             13: ['Memory', 'Episodic Memory', 'Emotion', 'Reward', 'Decision Making', 'Arousal', 'Cognitive', 'Manipulation', 'Retrieval', 'Vision', 'Perception', 'Hearing', 'Language'],
             14: ['Memory', 'Retrieval', 'Episodic Memory', 'Reward', 'Decision Making', 'Arousal', 'Salience', 'Cognitive', 'Manipulation', 'Hand', 'Vision', 'Perception', 'Language', 'Emotion'],
             ...
             17: ['Memory', 'Episodic Memory', 'Retrieval', 'Recall', 'Recognition', 'Arousal', 'Reward', 'Decision Making', 'Emotion', 'Cognitive', 'Preparation', 'Vision', 'Familiarity', 'Hearing', 'Language', 'Meaning', 'Representation'],
             18: ['Memory', 'Retrieval', 'Episodic Memory', 'Recall', 'Word', 'Emotion', 'Decision Making', 'Cognitive', 'Reward', 'Arousal', 'Cognitive Process', 'Manipulation', 'Execution', 'Vision', 'Hearing', 'Language', 'Speech', 'Meaning'],
             ...
             20: ['Memory', 'Episodic Memory', 'Familiarity', 'Retrieval', 'Recall', 'Encoding', 'Emotion', 'Decision Making', 'Reward', 'Arousal', 'Cognitive Process', 'Cognitive', 'Preparation', 'Manipulation', 'Execution', 'Thought', 'Vision', 'Hearing', 'Language', 'Meaning'],
             21: ['Memory', 'Episodic Memory', 'Retrieval', 'Recall', 'Emotion', 'Decision Making', 'Feedback', 'Reward', 'Salience', 'Arousal', 'Attention', 'Context', 'Cognitive', 'Manipulation', 'Execution', 'Anticipation', 'Vision', 'Hearing', 'Word', 'Language', 'Meaning'],
             22: ['Memory', 'Episodic Memory', 'Recall', 'Remembering', 'Recognition', 'Retrieval', 'Reward', 'Valence', 'Emotion', 'Decision Making', 'Loss', 'Anticipation', 'Arousal', 'Cognitive', 'Manipulation', 'Cognitive Process', 'Vision', 'Perception', 'Language', 'Hearing', 'Word', 'Meaning'],
             ...
             25: ['Memory', 'Episodic Memory', 'Encoding', 'Retrieval', 'Familiarity', 'Recognition', 'Recall', 'Reward', 'Fear', 'Emotion', 'Decision Making', 'Loss', 'Anticipation', 'Arousal', 'Cognitive', 'Manipulation', 'Vision', 'Preparation', 'Social Cognition', 'Perception', 'Language', 'Hearing', 'Semantic Processing', 'Meaning', 'Word']}
